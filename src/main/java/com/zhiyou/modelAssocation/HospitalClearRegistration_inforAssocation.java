...
public class HospitalClearRegistration_inforAssocation {	
	private Integer id;
	...
	public String toString() {
		return "HospitalClearRegistration_inforAssocation [id=" + id + ", medical_record=" + medical_record
				+ ", clear_status=" + clear_status + ", total_cost=" + total_cost + ", cash_pledge=" + cash_pledge
				+ ", still_need_pay=" + still_need_pay + ", balance=" + balance + ", clear_time=" + clear_time
				+ ", medical_costs=" + medical_costs + ", drug_cost=" + drug_cost + ", amount_paid=" + amount_paid

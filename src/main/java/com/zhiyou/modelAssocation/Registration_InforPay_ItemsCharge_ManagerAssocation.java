...
public class Registration_InforPay_ItemsCharge_ManagerAssocation {
	private int id;	
	...
	public String toString() {
		return "Registration_InforPay_ItemsCharge_ManagerAssocation [id=" + id + ", medical_record=" + medical_record
				+ ", patientNum=" + patientNum + ", name=" + name + ", certificate_type=" + certificate_type
				+ ", ID_num=" + ID_num + ", social_safe_num=" + social_safe_num + ", phone=" + phone + ", self_paying="
				+ self_paying + ", sex=" + sex + ", career=" + career + ", early_appointment=" + early_appointment
				+ ", doctor_id=" + doctor_id + ", status=" + status + ", noted=" + noted + ", time=" + time
				+ ", section_id=" + section_id + ", age=" + age + ", registration_fee=" + registration_fee + ", a=" + a
				+ ", balance=" + balance + ", cash_pledge=" + cash_pledge + ", total_cost=" + total_cost + "]";
	}

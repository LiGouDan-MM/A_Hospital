...
public class Doctor_CS {
	...
	public String toString() {
		return "Doctor_CS [id=" + id + ", name=" + name + ", certificate_type=" + certificate_type + ", ID_num="
				+ ID_num + ", phone=" + phone + ", special_plane=" + special_plane + ", sex=" + sex + ", age=" + age
				+ ", birther=" + birther + ", email=" + email + ", section_id=" + section_id + ", education="
				+ education + ", noted=" + noted + ", time=" + time + ", certificateType=" + certificateType
				+ ", section=" + section + "]";
	}

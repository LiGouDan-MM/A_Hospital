...
public class Registration_Infor {
       ...
       public void setId(int id) {
		...
		public String toString() {
			return "Registration_Infor [id=" + id + ", medical_record=" + medical_record + ", patientNum=" + patientNum
					...
					+ ", sex=" + sex + ", career=" + career + ", early_appointment=" + early_appointment
					+ ", doctor_id=" + doctor_id + ", status=" + status + ", noted=" + noted + ", time=" + time
					+ ", section_id=" + section_id + ", age=" + age + ", registration_fee=" + registration_fee

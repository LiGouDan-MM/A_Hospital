...
<body>
<form action="Registration/Add" method="post" class="definewidth m20">
<table class="table table-bordered table-hover definewidth m10">
    ...
    <tr>
        ...
        <td><input type="text" name="registration_fee" />元</td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td>
            <!-- 1是自费0不是自费  -->
            <input type="radio" name="self_paying" value="0" checked/>否&nbsp;&nbsp;&nbsp;
            <input type="radio" name="self_paying" value="1" />是
        </td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td>
           <input type="radio" name="early_appointment"  checked/>初诊&nbsp;&nbsp;&nbsp;
           <input type="radio" name="early_appointment" />复诊</td>
    </tr>
    <tr>
        ...
        <td>
		   <select name="section_id">
			     <c:forEach items="${section }" var="section">
			       <option value="${section.id }">${section.secco_name }</option>
			   </c:forEach>
		   </select>
	  </td>
    </tr>
